...
def processar_documentos(idDocumentoFiscal, cookies_session):
    ...
    response = httpx.get(url_documento, cookies=cookies_session, timeout=90, follow_redirects=True)
...
try:
    ...
    for id_documento_fiscal in id_documentos_fiscais:
        ...
        # response = httpx.get(url_documento, cookies=cookies_dict, timeout=None, follow_redirects=True)
